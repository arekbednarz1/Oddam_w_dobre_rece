let array = document.getElementsByClassName("donationes");
...
button.addEventListener("click", function (){
    ...
    let firstRow = 'ilość worków : '+quantityOfBags + ' zawartość : ';
    for (let i = 0; i < chekedText.length; i++) {
        firstRow=firstRow+chekedText[i];
        if(i<(chekedText.length-1)) firstRow+=", "
    }
    document.getElementById('all1').innerText=firstRow;
    ...
    document.getElementById("all2").innerText="Dla fundacji \"" + checkedOrganization + "\"";
